...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/waymococo.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', type=str, default='runs/train/yolov5scoco15/weights/best.pt', help='weights path') #ROOT / 'yolov5s.pt'
