...
# os.environ["PYTORCH_CUDA_ALLOC_CONF"] = "max_split_size_mb:11900"
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='models/yolov5s.pt', help='initial weights path')#yolov5l.pt yolov5s.pt
